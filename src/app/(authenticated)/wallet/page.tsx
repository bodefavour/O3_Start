...
export default function WalletPage() {
  ...
  const totalPortfolioValue = mockWallets.reduce(
                ...
                <Card key={wallet.id} className="overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      >
                        <Link href={`/wallet/send?currency=${wallet.symbol}`}>
                      ...
                      >
                        <Link href={`/wallet/receive?currency=${wallet.symbol}`}>
          ...
          {activeTab === "local" && (
            <div className="flex min-h-[400px] items-center justify-center">
              <div className="text-center">
                <p className="text-gray-600">No local currency wallets yet</p>
                <Button className="mt-4 gap-2 rounded-xl bg-[#00c48c] hover:bg-[#00b37d]">
                  <Plus className="h-4 w-4" />
                  Add Local Currency
                </Button>
              </div>
