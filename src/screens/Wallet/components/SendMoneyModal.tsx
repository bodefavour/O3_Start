...
export const SendMoneyModal = ({
    ...
    const renderConnector = (fromStep: ModalStep) => {
        ...
        return (
            <div
                className={`h-[2px] w-16 transition-colors ${isFilled ? "bg-[#0b1f3a]" : "bg-[#d1d5db]"
                    }`}
            />
        );
    };
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <fieldset>
                                ...
                                <div className="space-y-3">
                                    <label
                                        className={`flex cursor-pointer items-center justify-between rounded-2xl border ${priority === "standard"
                                    ...
                                    <label
                                        className={`flex cursor-pointer items-center justify-between rounded-2xl border ${priority === "fast"
                                                ? "border-[#00c48c] bg-[#f4fffb]"
                                                : "border-[#e5e7eb] bg-white"
                                            } px-4 py-4 transition-colors`}
                                    >
